package com.esprit.sim.SlimFit.step;
...
public class StepDetector {
    ...
    //InitialeWAIT_MODEL,Pas normal après 5 pas consécutifs,
    // Aucun 5 pas dans une rangée
    private final long WAIT_STEPS = 4;
    private final int WAIT_MODEL = 0;
    // ACTIVITYEn fonctionnement, le nombre d'étapes est synchronisé en temps réel sans vérification.
    private final int ACTIVITY_MODEL = 4;
    //Mode de fonctionnement, déjàWAIT_MODELLa détection
    private final int RUN_MODEL = 1;
    private int model;
