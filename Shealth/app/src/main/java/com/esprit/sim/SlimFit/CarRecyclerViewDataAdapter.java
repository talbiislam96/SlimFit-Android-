...
public class CarRecyclerViewDataAdapter extends RecyclerView.Adapter<ItemExercice> {
    RequestQueue queue;
    Context context;
    ...
    Spinner spinner;
    String Source;
    public CarRecyclerViewDataAdapter(List<JSONObject> carItemList, Context context, FragmentManager fragmentManager, Activity activity) {
            ...
            if(carItem != null) {
                ...
                holder.getCarImageView().setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        DetailExerciceFragment detailExerciceFragment = new DetailExerciceFragment();
                        try {
                            detailExerciceFragment.setIdExercice(carItem.getInt("id"));
                            detailExerciceFragment.setNomExercice(carItem.getString("nom"));
                            detailExerciceFragment.setDescriptionExercice(carItem.getString("description"));
                            detailExerciceFragment.setSource(carItem.getString("source"));

                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        fragmentManager.beginTransaction().replace(R.id.fragment,detailExerciceFragment).addToBackStack(null).commit();
                    }
                    });
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(text != "Veuillez choisir un programme"){
                                            ...
                                            int IdEx ;
                                            try {
                                                IdCat = carItem.getJSONObject("categorie").getInt("id");
